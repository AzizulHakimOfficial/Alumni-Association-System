                ...
                <table cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tbody>
                        <% try {
                                ...
                                ResultSet rs = st.executeQuery("select * from contact where mTo='Admin' order by contactId desc");
                                int id = 0;
                                while (rs.next()) {
                    ...
                    <div class="card-student">
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <input type="hidden" class="form-control" name="from" value="Admin" required>
                            </div>
                    ...
                    <tbody>
                        <%
                            try {
                                ...
                                Connection con = ConnectionProvider.getCon();
                                Statement st = con.createStatement();
                                ResultSet rs = st.executeQuery("select * from contact where mFrom='Admin' order by contactId desc ");
                                int id = 0;
                                while (rs.next()) {
                                    id = rs.getInt(1);
                        %>
